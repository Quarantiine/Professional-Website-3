...
var cs7SlideShowContainer = document.querySelector('.cs7-cs2-ic-slide-container');
var cs7SsBox = document.querySelector('.slide-container-box');
var cs7ArrowBtns1 = document.querySelector('.l-arr');
var cs7ArrowBtns2 = document.querySelector('.r-arr');
var n7 = 300;
...
cs7ArrowBtns1.addEventListener('click', function () {
  cs7ArrowBtnsSystem();
});
cs7ArrowBtns2.addEventListener('click', function () {
  cs7ArrowBtnsSystem2();
});
